...
const configureAppQuitHandling_1 = __importDefault(
  require('./configureAppQuitHandling')
);
const configureAutoUpdates_1 = __importDefault(
  require('./configureAutoUpdates')
);
const configureDeepLinking_1 = __importDefault(
  require('./configureDeepLinking')
);
...
const LOGO_TEMPLATE_PATH = path_1.default.join(
  __dirname,
  `..`,
  `logoTemplate.png`
);
const run = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const transparentWindow = yield (0, createTransparentWindow_1.default)(
      state,
      PRELOAD_PATH
    );
